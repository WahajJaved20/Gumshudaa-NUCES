    ...
    <div className="min-h-screen flex items-center justify-center bg-primaryColor">
      <div className="bg-white p-8 rounded-lg shadow-md">
        ...
        <ul className="list-disc pl-4 mb-6">
          ...
          <li>Shoot us a message - we're always happy to help! You can find me on Github and raise an issue at <a target="_blank" href="https://github.com/WahajJaved20/Gumshudaa-NUCES" className="underline">Gumshuda NUCES</a>.</li>
        </ul>
        <p className="mb-6">And while you're here, enjoy this video:</p>
        <YouTube opts={{ height: '270', width: '480' }} videoId={videoId} />
      </div>
    </div>
  );
};
